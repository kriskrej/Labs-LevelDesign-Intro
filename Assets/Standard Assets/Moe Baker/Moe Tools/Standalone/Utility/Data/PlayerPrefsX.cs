...
namespace Moe.Tools {
    public static class PlayerPrefsX {
        ...
        public static string SavePath {
            get { return Path.Combine(Application.persistentDataPath, "Player Prefs X.dat"); }
        }
        ...
        public static void Add(string ID, object obj) {
            if (CheckSerialization(obj)) {
                ...
                Debug.LogError("Cant Serialize Type (" + type.FullName +
                               "), Its Either Not Marked Serializable Or Has Memebers Not Marked Serializable");
            }
        }
